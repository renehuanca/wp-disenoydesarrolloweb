...
<div data-aos="fade-up" class="slider-hero position-relative z-1 container">
  <div class="frase-item active">
    <p class="lead fs-1">DISEÑO Y</p>
    <h1 class="display-1 fw-bold">DESARROLLO WEB</h1>
  </div>
  <div class="frase-item">
    <p class="lead fs-1">DISEÑO DE</p>
    <h1 class="display-1 fw-bold">TIENDAS VIRTUALES</h1>
  </div>
  <div class="frase-item">
    <p class="lead fs-1">DOMINIO Y</p>
    <h1 class="display-1 fw-bold">HOSPEDAJE WEB</h1>
  </div>
