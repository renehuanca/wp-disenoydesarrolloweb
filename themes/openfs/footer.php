...
<footer class=" footer pb-2 pt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <ul class="list-unstyled" style="font-size: .75rem;">
                    ...
                    <li>
                        <svg class="text-primary" style="width: 22px;" xmlns="http://www.w3.org/2000/svg"
    ...
    <p class="text-center fw-light pt-4 font-monospace" style="font-size: .8rem;">©2025 - Desarrollado por
        OPENFS
        LLC</p>
</footer>
